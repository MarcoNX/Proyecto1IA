...
setEnv:- %Inicializa variables de entorno
	setenv('ProyectoIA','C:/Users/maestria/BaseConocimientosIA.txt').%Constante de ubicación del KB en el disco duro
...
agregarPropiedadDeClase(Clase,Propiedad,Valor):-
	getEnv(KB),
...
agregarPreferenciaDePropiedadDeClase(Clase,Preferencia,Peso):-
	getEnv(KB),
	add_class_property_preference(Clase,Preferencia,Peso,KB,NKB),
	updEnv(NKB).
...
agregarRelacionDeClase(ClaseA,Relacion,ClaseB):-
	getEnv(KB),
...
agregarPreferenciaDeRelacionDeClase(ClaseA,Preferencia,Peso):-
	getEnv(KB),
	add_class_relation_preference(ClaseA,Preferencia,Peso,KB,NKB),
	updEnv(NKB).
...
agregarPropiedadDeObjeto(Nombre,Propiedad,Valor):-
	getEnv(KB),
...
agregarRelacionDeObjeto(ObjetoA,Relacion,ObjetoB):-
	getEnv(KB),
...
cambiarNombreDeClase(Clase,Nombre):-
	getEnv(KB),
	change_class_name(Clase,Nombre,KB,NKB),
	updEnv(NKB).
...
cambiarValorDePropiedadDeClase(Clase,Propiedad,Valor):-
	getEnv(KB),
	change_value_class_property(Clase,Propiedad,Valor,KB,NKB),
	updEnv(NKB).
...
cambiarValorDePreferenciaDePropiedadDeClase(Clase,Preferencia,Peso):-
	getEnv(KB),
	change_weight_class_property_preference(Clase,Preferencia,Peso,KB,NKB),
	updEnv(NKB).
...
cambiarValorDeRelacionDeClase(Clase,RelacionAnterior,RelacionNueva):-
	getEnv(KB),
	change_value_class_relation(Clase,RelacionAnterior,RelacionNueva,KB,NKB),
	updEnv(NKB).
...
cambiarPesoDePreferenciaDeRelacionDeClase(Clase,Preferencia,Peso):-
	getEnv(KB),
	change_weight_class_relation_preference(Clase,Preferencia,Peso,KB,NKB),
	updEnv(NKB).
...
cambiarNombreDeObjeto(Objeto,Nombre):-
	getEnv(KB),
	change_object_name(Objeto,Nombre,KB,NKB),
	updEnv(NKB).
...
cambiarValorDePropiedadDeObjeto(Objeto,Propiedad,Valor):-
	getEnv(KB),
	change_value_object_property(Objeto,Propiedad,Valor,KB,NKB),
	updEnv(NKB).
...
cambiarPesoDePreferenciaDePropiedadDeObjeto(Objeto,Preferencia,Peso):-
	getEnv(KB),
	change_weight_object_property_preference(Objeto,Preferencia,Peso,KB,NKB),
	updEnv(NKB).
...
cambiarValorDeRelacionDeObjeto(Objeto,RelacionAnterior,RelacionNueva):-
	getEnv(KB),
	change_value_object_relation(Objeto,RelacionAnterior,RelacionNueva,KB,NKB),
	updEnv(NKB).
...
cambiarPesoDePreferenciaDeRelacionDeObjeto(Objeto,Preferencia,Peso):-
	getEnv(KB),
	change_weight_object_relation_preference(Objeto,Preferencia,Peso,KB,NKB),
	updEnv(NKB).
